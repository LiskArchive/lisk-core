...
```
docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:4.0.4 blockchain:download --network=mainnet --output=/home/lisk/.lisk/tmp/

docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:4.0.4 blockchain:import /home/lisk/.lisk/tmp/blockchain.db.tar.gz

docker run --volume lisk-data:/home/lisk/.lisk -it --rm --entrypoint rm lisk/core:4.0.4 -f /home/lisk/.lisk/tmp/blockchain.db.tar.gz
