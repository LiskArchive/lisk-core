...
```
docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:3.0.0-rc.0 blockchain:download --network=betanet --output=/home/lisk/.lisk/tmp/
docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:3.0.0-rc.0 blockchain:import /home/lisk/.lisk/tmp/blockchain.db.tar.gz
docker run --volume lisk-data:/home/lisk/.lisk -it --rm --entrypoint rm lisk/core:3.0.0-rc.0 -f /home/lisk/.lisk/tmp/blockchain.db.tar.gz
