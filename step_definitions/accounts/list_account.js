...
Then("I should get account details according to {string}", async function(
  params
) {
  params = splitBy(params);
...
Then("{string} and {string} should get {string} account", async function(
  user1,
  user2
) {
