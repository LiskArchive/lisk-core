...
Then(/transfer (\d+)LSK to all account from genesis account/, async function(
  amount
) {
  try {
...
Then(/Validate if (\d+)LSK was transfered was successful/, async function(
  amount
) {
  try {
