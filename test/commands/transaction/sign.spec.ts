		...
		describe('sign transaction from single account', () => {
			...
			it('should return signed transaction in json format', async () => {
				...
				expect(baseIPC.prototype.printJSON).toHaveBeenCalledWith({
					...
					id: 'afe231c5a3b265d870f6528b3f11a8dc3125b734b8b4f42d9c847a29655bee5a',
					moduleID: 2,
					assetID: 0,
					nonce: '2',
					fee: '100000000',
		...
		describe('sign multi signature registration transaction', () => {
			...
			it('should return fully signed transaction string in hex format', async () => {
				...
				expect(baseIPC.prototype.printJSON).toHaveBeenCalledWith({
					...
					id: 'beaf8047900f832ee615c8e2da4f40f942b9cd4983a03308f384cdd29d272392',
					moduleID: 4,
					assetID: 0,
					nonce: '2',
					fee: '100000000',
			...
			describe('optional keys are specified', () => {
				...
				it('should return fully signed transaction string in hex format', async () => {
					...
					expect(baseIPC.prototype.printJSON).toHaveBeenCalledWith({
						...
						id: '9a931dfff080538949a7daff9ae50961346b6472d75776247b0c23f04e925596',
						asset: {
							amount: '100',
							data: 'send token',
							recipientAddress: 'ab0041a7d3f7b2c290b5b834d46bdc7b7eb85815',
	...
	describe('online', () => {
		describe('sign transaction from single account', () => {
			...
			it('should return signed transaction in json format', async () => {
				...
				expect(baseIPC.prototype.printJSON).toHaveBeenCalledWith({
					transaction:
						'656e636f646564207472616e73616374696f6e',
				});
				expect(baseIPC.prototype.printJSON).toHaveBeenCalledWith({
