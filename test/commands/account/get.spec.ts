...
describe('account:get command', () => {
  ...
  ipcInvokeStub
    ...
    .resolves({ account: { $id: 'dummy', type: 'object', properties: { address: { dataType: 'bytes' } } } })
    .withArgs('app:getAccount', { address })
    .resolves('ChTDqyrCNRLZv2KwJ3XiLPgN+BTrGxAAGAAiAggAKjoKGQoKZ2VuZXNpc184NhgAIAAoADCAoJSljR0SHQoUw6sqwjUS2b9isCd14iz4DfgU6xsQgKCUpY0d');
  ...
  describe('account:get address', () => {
    setupTest()
      ...
      .it('should get an account info and display as an object', () => {
        ...
        expect(ipcInvokeStub).to.have.been.calledWithExactly('app:getAccount', { address });
