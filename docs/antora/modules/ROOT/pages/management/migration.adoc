...
We *recommend* to install *v3.1.1* of Lisk Core, because it comes with the Mainnet snapshot height preconfigured. If using an existing data directory, kindly make sure to use the `--overwrite-config` flag when restarting the application.
