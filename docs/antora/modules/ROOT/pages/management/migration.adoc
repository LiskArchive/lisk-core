...
NOTE: If your version is lower than 3.1.0-rc.1, ensure to update Lisk Core before proceeding with the migration.
...
IMPORTANT: The flag `--add-legacy` is only available in Lisk Core v4.0.0-rc.2.
