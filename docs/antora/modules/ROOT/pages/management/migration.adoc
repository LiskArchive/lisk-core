...
----
lisk-migrator --snapshot-height {snapshotHeight} --output ~/.lisk/lisk-core/config/mainnet --auto-migrate-config --auto-start-lisk-core-v4
----
--
Testnet::
+
...
[source,bash,subs=attributes+]
----
lisk-migrator --snapshot-height {snapshotHeightTestnet} --output ~/.lisk/lisk-core/config/testnet  --auto-migrate-config --auto-start-lisk-core-v4
----
--
====
