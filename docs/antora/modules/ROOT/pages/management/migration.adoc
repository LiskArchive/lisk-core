...
NOTE: To send transactions from multisignature accounts, please follow the instructions xref:beta@ROOT::integrate-blockchain/multisignature-auccounts-and-transactions.adoc#how-to-create-a-multi-signature-transaction[here].
