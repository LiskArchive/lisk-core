...
IMPORTANT: The registration of the legacy validator keys has to be done *latest at the end of `initRounds`*.
Otherwise, the validator will be *banned* in the network.
