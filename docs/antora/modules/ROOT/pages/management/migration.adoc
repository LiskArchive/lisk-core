...
:url_sdk_protocol_voteweight: ROOT::understand-blockchain/consensus/pos-poa.adoc#validator-weight
...
The Lisk migrator will not install Lisk Core v4, nor will it uninstall Lisk Core v3.0.4, these are steps that need to be done manually as described below.
...
If you have Node.js installed ensure to use version 18 (LTS)
====
...
=== Setting up Lisk Core v4

Follow the guide how to xref:{url_core_install}[setup Lisk Core v4] for the binary distribution.

IMPORTANT: Don't start Lisk Core v4 yet.

=== Add your validator information to the node config
...
Next, use the CLI of Lisk Core v4 to generate the delegate configuration data.
...
[source,bash]
----
lisk-core forging:enable 89aa5fc8861d392f60662f76a379cc348fe97d28 0 0 0
----
