...
:devnet_passphrase: https://github.com/LiskHQ/lisk-core/blob/v4.0.0-beta.4/config/devnet/passphrase.json
// TODO: replace the above url with this one when when the docs are released - devnet_passphrase: https://github.com/LiskHQ/lisk-core/blob/main/config/devnet/passphrase.json
...
----
--
NOTE: The passphrase for the genesis account can be found here in the Lisk Core GitHub repository under the following path: xref:{devnet_passphrase}[config/devnet/passphrase.json].
