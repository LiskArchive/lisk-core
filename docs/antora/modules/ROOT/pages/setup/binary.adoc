...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/testnet/4.0.0-rc.6/lisk-core-v4.0.0-rc.6-linux-x64.tar.gz
----
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/testnet/4.0.0-rc.6/lisk-core-v4.0.0-rc.6-darwin-x64.tar.gz
----
--
====
