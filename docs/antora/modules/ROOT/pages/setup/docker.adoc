...
// TODO: replace the above url with this one when the docs are released - devnet_passphrase: https://github.com/LiskHQ/lisk-core/blob/main/config/devnet/passphrase.json
