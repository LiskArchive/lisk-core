...
_See code: [dist/commands/system/metadata.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.0-rc.0/dist/commands/system/metadata.ts)_
...
_See code: [dist/commands/system/node-info.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.0-rc.0/dist/commands/system/node-info.ts)_
