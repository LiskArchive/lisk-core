...
_See code: [dist/commands/endpoint/invoke.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.0-beta.5/dist/commands/endpoint/invoke.ts)_
...
_See code: [dist/commands/endpoint/list.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.0-beta.5/dist/commands/endpoint/list.ts)_
