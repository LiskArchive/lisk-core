...
_See code: [dist/commands/genesis-block/create.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.4/dist/commands/genesis-block/create.ts)_
...
_See code: [dist/commands/genesis-block/download.ts](https://github.com/LiskHQ/lisk-core/blob/v4.0.4/dist/commands/genesis-block/download.ts)_
